      ...
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div className="card" style={{ padding: 22 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 10, marginBottom: 18 }}>
            <button onClick={() => signInWithOAuth("google")} disabled={busy} style={{ width: "100%", padding: "11px 16px", borderRadius: 8, border: "1px solid #333", background: "#fff", color: "#333", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontFamily: "Barlow, sans-serif", transition: "background .15s" }}>
            ...
            <button onClick={() => signInWithOAuth("apple")} disabled={busy} style={{ width: "100%", padding: "11px 16px", borderRadius: 8, border: "1px solid #333", background: "#000", color: "#fff", fontSize: 14, fontWeight: 600, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontFamily: "Barlow, sans-serif", transition: "background .15s" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 18 }}>
            ...
            <div style={{ fontSize: 10, color: "#444", fontWeight: 700, textTransform: "uppercase", letterSpacing: 1.5, fontFamily: "Barlow Condensed" }}>or with email</div>
            <div style={{ flex: 1, height: 1, background: "#252525" }} />
          </div>
